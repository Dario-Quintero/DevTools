...
const Card = ({ article }) => {
  return (
    <div className="text-black dark:bg-black border border-white/20 rounded-lg w-72 my-5 overflow-hidden">
      ...
      <div className="h-[60%] px-4 py-4 flex flex-col justify-between">
        ...
        <Link
          to={article?.url}
          target="_blank"
          className="w-[50%] flex gap-2 items-center px-4 py-2 mt-2 border border-white/20 rounded-md text-black dark:text-white hover:bg-black/5 hover:animate-pulse transition-all"
        >
