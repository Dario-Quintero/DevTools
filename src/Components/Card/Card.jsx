...
const Card = ({ article }) => {
  return (
    <div className="text-black bg-white dark:bg-black border dark:border-white/20 rounded-lg w-full max-w-72 mt-2 overflow-hidden">
      ...
      <div className="h-[60%] px-4 py-4 flex flex-col justify-between">
        ...
        <Link
          to={article?.url}
          target="_blank"
          className="w-40 min-w-[50%] flex gap-2 items-center px-4 py-2 mt-2 border dark:border-white/20 rounded-md text-black dark:text-white hover:bg-black/5 hover:animate-pulse transition-all"
        >
